...
sweep is TEN crates (the update procedure above still lists nine; F5.2/S3
added the tenth, `ggo_emerald_panel`, after that block was last edited — F5.1
added `ggo_map_panel` and `ggo_import_panel`).
